const embed = {
  ...
  fields: [
    ...
    },
    {
      name: "2nd Wish",
      value:
        "[• Ventos Special Steak x5](http://www.aurakingdom-db.com/item/11097-ventos-special-steak)",
      inline: true
    },
    {
      name: "3rd Wish",
...
module.exports = {
  ...
  execute(message, args) {
    embed.description = `${message.author} | Hades' Prayers`;
