const embed = {
  ...
  fields: [
    ...
    },
    {
      name: "3rd Wish",
      value:
        "[• Katars of the Elite Guardian x1](http://www.aurakingdom-db.com/item/12382-katars-of-the-elite-guardian)\n[• Ironguard General's Gauntlets x1](http://www.aurakingdom-db.com/item/13259-ironguard-generals-gauntlets)",
      inline: true
    },
    {
      name: "4th Wish",
      value:
        "[• Wild Bird Eggs x20](http://www.aurakingdom-db.com/item/11465-wild-bird-eggs)\n[• Crimson Body x5](http://www.aurakingdom-db.com/item/14482-crimson-body)",
      inline: true
    },
    {
      name: "5th Wish",
...
module.exports = {
  ...
  execute(message, args) {
    embed.description = `${message.author} | Kitami's Prayers`;
