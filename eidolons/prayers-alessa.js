  ...
  fields: [
    {
      name: "1st Wish",
      value:
        "[• Steel Chef's Knife x1](http://www.aurakingdom-db.com/item/15237-steel-chefs-knife)",
      inline: true
    },
    {
      name: "2nd Wish",
      value:
        "[• Fia's Brilliant Fairy Dust x1](http://www.aurakingdom-db.com/item/10354-fias-brilliant-fairy-dust)",
      inline: true
    },
    {
      name: "3rd Wish",
    ...
    },
    {
      name: "4th Wish",
      value:
        "[• Roast Chicken Lasagna x5](http://www.aurakingdom-db.com/item/11546-roast-chicken-lasagna)\n[• Fruit and Honey Tea x5](http://www.aurakingdom-db.com/item/11558-fruit-and-honey-tea)",
      inline: true
    },
    {
      name: "5th Wish",
...
module.exports = {
  ...
  execute(message, args) {
    embed.description = `${message.author} | Alessa's Prayers`;
