  ...
  fields: [
    {
      name: "1st Wish",
      value:
        "[• Miracle Flower x2](http://www.aurakingdom-db.com/item/11455-miracle-flower)",
      inline: true
    },
    {
      name: "2nd Wish",
...
module.exports = {
  ...
  execute(message, args) {
    embed.description = `${message.author} | Endora's Prayers`;
