  ...
  fields: [
    {
      name: "1st Wish",
      value:
        "[• Clark's Fresh Milk x2](http://www.aurakingdom-db.com/item/11076-clarks-fresh-milk)",
      inline: true
    },
    {
      name: "2nd Wish",
      value:
        "[• Strengthening Spanner x2](http://www.aurakingdom-db.com/item/12735-strengthening-spanner)",
      inline: true
    },
    {
      name: "3rd Wish",
      value:
        "[• Requiem Headgear x1](http://www.aurakingdom-db.com/item/10356-requiem-headguard)\n[• Requiem Light Armor x1](http://www.aurakingdom-db.com/item/10357-requiem-light-armor)",
      inline: true
    },
    {
      name: "4th Wish",
      value:
        "[• Wise Master's Rod x1](http://www.aurakingdom-db.com/item/12813-wise-masters-rod)\n[• Thornfang Fish x5](http://www.aurakingdom-db.com/item/14467-thornfang-fish)",
      inline: true
    },
    {
      name: "5th Wish",
...
module.exports = {
  ...
  execute(message, args) {
    embed.description = `${message.author} | Serif's Prayers`;
