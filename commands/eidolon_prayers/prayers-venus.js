const embed = {
  ...
  fields: [
    ...
    },
    {
      name: "2nd Wish",
      value:
        "[• Cocoa Fruit x15](http://www.aurakingdom-db.com/item/11462-cocoa-fruit)",
      inline: true
    },
    {
      name: "3rd Wish",
      value:
        "[• Lightening Hammer x10](http://www.aurakingdom-db.com/charts/archeology-schedule)\n[• Enhanced Lightening Chisel x10](http://www.aurakingdom-db.com/item/12761-enhanced-lightening-chisel)",
      inline: true
    },
    {
      name: "4th Wish",
...
module.exports = {
  ...
  execute(message, args) {
    embed.description = `${message.author} | Venus' Prayers`;
