  ...
  fields: [
    {
      name: "1st Wish",
      value:
        "[• Red Leech x10](http://www.aurakingdom-db.com/item/13022-red-leech)",
      inline: true
    },
    {
      name: "2nd Wish",
...
module.exports = {
  ...
  execute(message, args) {
    embed.description = `${message.author} | Verdandi's Prayers`;
