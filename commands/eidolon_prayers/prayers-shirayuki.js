const embed = {
  ...
  fields: [
    ...
    },
    {
      name: "2nd Wish",
      value:
        "[• Ritual Trophy Core x1](http://www.aurakingdom-db.com/item/10515-ritual-trophy-core)",
      inline: true
    },
    {
      name: "3rd Wish",
...
module.exports = {
  ...
  execute(message, args) {
    embed.description = `${message.author} | Shirayuki's Prayers`;
