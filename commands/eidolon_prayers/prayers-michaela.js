const embed = {
  ...
  fields: [
    ...
    },
    {
      name: "2nd Wish",
      value:
        "[• Revitilization Drink x3](http://www.aurakingdom-db.com/item/11589-revitilization-drink)",
      inline: true
    },
    {
      name: "3rd Wish",
      value:
        "[• Ramgram's Crystalline Heart x1](http://www.aurakingdom-db.com/item/12511-ramgrams-crystalline-heart)\n[• Magically Enhanced Muck x5](http://www.aurakingdom-db.com/item/12519-magically-enhanced-muck)",
      inline: true
    },
    {
      name: "4th Wish",
...
module.exports = {
  ...
  execute(message, args) {
    embed.description = `${message.author} | Michaela's Prayers`;
