  ...
  fields: [
    {
      name: "1st Wish",
      value:
        "[• Princess Hardscale Fish x5](http://www.aurakingdom-db.com/item/14462-princess-hardscale-fish)",
      inline: true
    },
    {
      name: "2nd Wish",
      value:
        "[• Titan's Spirit Flower x1](http://www.aurakingdom-db.com/item/14254-titans-spirit-flower)",
      inline: true
    },
    {
      name: "3rd Wish",
      value:
        "[• Vigor Leaves x10](http://www.aurakingdom-db.com/item/11449-vigor-leaves)\n[• Cliffside Blossom x10](http://www.aurakingdom-db.com/item/15605-cliffside-blossom)",
      inline: true
    },
    {
      name: "4th Wish",
      value:
        "[• Lestaro's Strength of the Earth x1](http://www.aurakingdom-db.com/item/12522-lestaros-strength-of-the-earth)\n[• Ice Crystal Plant Extract x20](http://www.aurakingdom-db.com/item/14250-ice-crystal-plant-extract)",
      inline: true
    },
    {
      name: "5th Wish",
...
module.exports = {
  ...
  execute(message, args) {
    embed.description = `${message.author} | Demeter's Prayers`;
