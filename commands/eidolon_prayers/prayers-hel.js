  ...
  fields: [
    {
      name: "1st Wish",
      value:
        "[• Refined Elemental Core x1](http://www.aurakingdom-db.com/item/10509-refined-elemental-core)",
      inline: true
    },
    {
      name: "2nd Wish",
      value:
        "[• Wisdom of the Ancients x2](http://www.aurakingdom-db.com/item/14127-wisdom-of-the-ancients)",
      inline: true
    },
    {
      name: "3rd Wish",
...
module.exports = {
  ...
  execute(message, args) {
    embed.description = `${message.author} | Hel's Prayers`;
