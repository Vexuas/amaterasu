  ...
  fields: [
    {
      name: "1st Wish",
      value:
        "[• Bread Pudding x2](http://www.aurakingdom-db.com/item/11533-bread-pudding)",
      inline: true
    },
    {
      name: "2nd Wish",
...
module.exports = {
  ...
  execute(message, args) {
    embed.description = `${message.author} | Kotonoha's Prayers`;
