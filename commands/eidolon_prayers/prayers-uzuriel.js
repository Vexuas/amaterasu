  ...
  fields: [
    {
      name: "1st Wish",
      value:
        "[• Large Lunchbox x2](http://www.aurakingdom-db.com/item/11593-large-lunchbox)",
      inline: true
    },
    {
      name: "2nd Wish",
      value:
        "[• Cactakara Forest's Patrol Reward x1](http://www.aurakingdom-db.com/item/11382-cactakara-forests-patrol-reward)",
      inline: true
    },
    {
      name: "3rd Wish",
      value:
        "[• Rainbow Scale x5](http://www.aurakingdom-db.com/item/13182-rainbow-scale)\n[• Rainbow Teardrop x5](http://www.aurakingdom-db.com/item/13183-rainbow-teardrop)",
      inline: true
    },
    {
      name: "4th Wish",
      value:
        "[• Tattooed Skin x1](http://www.aurakingdom-db.com/item/12541-tattooed-skin)\n[• Greater Strength Potion x5](http://www.aurakingdom-db.com/item/12695-greater-strength-potion)",
      inline: true
    },
    {
      name: "5th Wish",
...
module.exports = {
  ...
  execute(message, args) {
    embed.description = `${message.author} | Uzuriel's Prayers`;
