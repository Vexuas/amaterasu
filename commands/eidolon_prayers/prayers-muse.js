const embed = {
  ...
  fields: [
    ...
    },
    {
      name: "3rd Wish",
      value:
        "[• Lightening Spanner x1](http://www.aurakingdom-db.com/item/12741-lightening-spanner)\n[• Shrill Vocal Cords x1](http://www.aurakingdom-db.com/item/12520-shrill-vocal-cords)",
      inline: true
    },
    {
      name: "4th Wish",
...
module.exports = {
  ...
  execute(message, args) {
    embed.description = `${message.author} | Muse's Prayes`;
