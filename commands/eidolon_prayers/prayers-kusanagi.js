const embed = {
  ...
  fields: [
    ...
    },
    {
      name: "2nd Wish",
      value:
        "[• Veggies with Fresh Aioli x2](http://www.aurakingdom-db.com/item/11526-veggies-with-fresh-aioli)",
      inline: true
    },
    {
      name: "3rd Wish",
...
module.exports = {
  ...
  execute(message, args) {
    embed.description = `${message.author} | Kusanagi's Prayers`;
