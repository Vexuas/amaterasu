  ...
  fields: [
    {
      name: "1st Wish",
      value:
        "[• Slighty Damaged Animal Bones x2](http://www.aurakingdom-db.com/item/14099-slighty-damaged-animal-bones)",
      inline: true
    },
    {
      name: "2nd Wish",
...
module.exports = {
  ...
  execute(message, args) {
    embed.description = `${message.author} | Grimm's Prayers`;
